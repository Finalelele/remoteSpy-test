-- [[ KRALLDEN SPY v9.5.7 - MANUAL REFRESH ONLY ]] --
...
local function forceUpdateCanvas()
    task.defer(function()
        if detailList and DetailsScroll then
            local newSize = detailList.AbsoluteContentSize.Y + 40
            DetailsScroll.CanvasSize = UDim2.new(0, 0, 0, newSize)

            -- 🔥 ВАЖНО: обновляем позицию скролла
...
Title.Text = "KRALLDEN SPY v9.5.7"; Title.TextColor3 = Color3.new(1, 1, 1); Title.Font = Enum.Font.SourceSansBold; Title.TextSize = 16; Title.ZIndex = 11; Title.TextXAlignment = 0
